...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RecordDescriptor::record_count() const {
  // @@protoc_insertion_point(field_get:zb.dcts.node.zczh.zhdirection.RecordDescriptor.record_count)
...
inline void RecordDescriptor::set_record_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:zb.dcts.node.zczh.zhdirection.RecordDescriptor.record_count)
}
